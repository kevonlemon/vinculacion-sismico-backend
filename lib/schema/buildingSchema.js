...
export const BuildingSchema = z.object({
  ...
  ocupacion: z.string().trim().min(1, "La ocupación del edificio es requerida"),
  ...
  foto_edificio: z
    .custom((file) => file && file.buffer, "Debe subir una foto del edificio")
    .refine(
  ...
  grafico_edificio: z
    .custom((file) => file && file.buffer, "Debe subir un archivo")
    .optional(),
