...
const register = async (userData, parsedImage) => {
  ...
  try {
    ...
    // AGREGAR AQUI LA LOGICA PARA QUE LA FOTO RECIBIDA SE SUBA EN  FIREBASE Y FIREBASE DEVUELVA LA URL DE LA FOTO, EL ARCHIVO A SUBIR ES EL PARAMETRO "parsedImage"
